...
public class RsaKeyHelper {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
        ...
        Map<String, byte[]> map = RsaKeyHelper.generateKey("123456");
        byte[] pub = map.get("pub");
        byte[] pri = map.get("pri");
        try {
            PublicKey publicKey = rsaKeyHelper.getPublicKey(pub);
        ...
        try {
            PrivateKey privateKey = rsaKeyHelper.getPrivateKey(pri);
